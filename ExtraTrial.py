...
def extra():
    ...
    yellow = Label(delivery, text="Delivery Details", bg="#f99406", fg="White",
    ...
    Button(delivery, text='Add', bg="red", fg="white", font=('Times New Roman', 18), command=Add_delivery).place(x=80,
                                                                                                                 y=500)
    Button(delivery, text='Update', bg="red", fg="white", font=('Times New Roman', 18), command=Update_delivery).place(
        x=180, y=500)
    Button(delivery, text='Delete', bg="red", fg="white", font=('Times New Roman', 18), command=Delete_delivery).place(
        x=310, y=500)
    Button(delivery, text='Clear', bg="red", fg="white", font=('Times New Roman', 18), command=Clear_delivery).place(x=430,
                                                                                                                     y=500)
